...
def afcache_xfuser_flux_forward(
    ...
    """
    The [`FluxTransformer2DModel`] forward method with AFCache.
    Args:
    ...
    if hasattr(self, 'stage_info') and hasattr(self.stage_info, 'after_flags') and \
       self.stage_info.after_flags.get("single_transformer_blocks", True):
