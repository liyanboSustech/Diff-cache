...
from afcache_xfuser_flux_forward import afcache_xfuser_flux_forward
def main():
    ...
    pipe.transformer.__class__.forward = afcache_xfuser_flux_forward

    for double_transformer_block in pipe.transformer.transformer_blocks:
        double_transformer_block.__class__.forward = afcache_flux_double_block_forward

    for single_transformer_block in pipe.transformer.single_transformer_blocks:
        single_transformer_block.__class__.forward = afcache_flux_single_block_forward
    ...
    if input_config.output_type == "pil":
        ...
        if pipe.is_dp_last_group():
            for i, image in enumerate(output.images):
                ...
                image_name = f"flux_result_{parallel_info}_{image_rank}_afcache.png"
